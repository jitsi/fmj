...
public class Decoder extends AbstractCodec
{
    ...
    public Format[] getSupportedOutputFormats(Format input)
    {
        ...
        else
        {
            ...
            // mgodehardt if input is 8Bit, it has no endian, this causes
            // problems with other codecs when you give them 16bit with no
            // endian
            // TODO: it would be nice to have it based on target platform ( is
            // mac big endian ? )
            ...
            final AudioFormat result = new AudioFormat(AudioFormat.LINEAR,
                    inputCast.getSampleRate(), 16, 1, endian,
    ...
    public int process(Buffer inputBuffer, Buffer outputBuffer)
    {
        ...
        final boolean bigEndian = ((AudioFormat) outputFormat).getEndian() == AudioFormat.BIG_ENDIAN; // TODO:
                                                                                                      ...
                                                                                                      // for
                                                                                                      // undefined
        MuLawDecoderUtil.muLawDecode(bigEndian, (byte[]) inputBuffer.getData(),
