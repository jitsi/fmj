...
/**
 * This is a utility class for creating clones of PullBufferDataSource. THe
 * class reflects the functionality of a PullBufferDataSource and provides a
 ...
 * time the PullBufferDataSource's streams are read. This class also implements
 * the CaptureDevice interface.
 */
public class CloneableCaptureDevicePullBufferDataSource extends
        PullBufferDataSource implements SourceCloneable, CaptureDevice
{
     ...
     */
    public CloneableCaptureDevicePullBufferDataSource(
