 ...
 * time the PushBufferDataSource's streams call transferData(). This class also
 * implements the CaptureDevice interface.
 */
public class CloneableCaptureDevicePushBufferDataSource extends
        PushBufferDataSource implements SourceCloneable, CaptureDevice
{
     ...
     */
    public CloneableCaptureDevicePushBufferDataSource(
